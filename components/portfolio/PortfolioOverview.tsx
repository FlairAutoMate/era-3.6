...
import { BentoGrid, BentoStat, BentoCard } from '../widgets/BentoGrid';
        ...
        <div className="max-w-[1400px] mx-auto px-6 pt-32 pb-44 animate-era-in bg-black min-h-screen text-white font-sans">
            <header className="mb-14">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
                    ...
                    <KPIMedium label="Grønn Portefølje" value="42%" sub="Energi-klasse A-C" icon={Icons.Zap} color="text-emerald-500" />
                </div>
            </header>

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20">
                {/* 1. ESG & Energi-distribusjon */}
                <AuraCard className="lg:col-span-4 p-8 bg-[#0D0D0E] border-white/5">
                    ...
                    <div className="mt-12 p-5 bg-indigo-600/5 border border-indigo-500/10 rounded-2xl">
                        <p className="text-[11px] text-zinc-500 leading-relaxed">
                            <Icons.Sparkles className="inline mr-2 text-indigo-400" size={12} />
                            Ved å oppgradere 2 enheter fra F til D kan porteføljens EI-score øke med 4.2 poeng.
                        </p>
                    </div>
                </AuraCard>

                {/* 2. Investerings-benchmark */}
                <AuraCard className="lg:col-span-8 p-8 bg-[#0D0D0E] border-white/5">
                    <div className="flex items-center justify-between mb-10">
                         ...
                         <div className="flex gap-4">
                            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-indigo-500" /> <span className="text-[9px] font-black uppercase text-zinc-600">Verdi</span></div>
                            <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-zinc-800" /> <span className="text-[9px] font-black uppercase text-zinc-600">Risiko</span></div>
                         </div>
                    </div>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 gap-4">
                    {filteredProperties.map((p) => {
                        const tgScore = getPropertyTGScore(p.address);
